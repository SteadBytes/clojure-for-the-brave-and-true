...
; actually answered this exercise in ex 5. matching-parts and symmetrize-body-parts
; copied from ex 5. This is a demo of usage for more than just alien parts
...
(def human-body-parts (symmetrize-body-parts asym-body-parts 2))
(def radial-5-alien-body-parts (symmetrize-body-parts asym-body-parts 5))
(def radial-8-alien-body-parts (symmetrize-body-parts asym-body-parts 8))